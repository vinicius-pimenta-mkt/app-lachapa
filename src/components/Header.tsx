    ...
    <header className="la-chapa-header p-4 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link href="/cart" className="relative" style={{ position: 'fixed', top: '20px', right: '20px', zIndex: '50' }}>
            <button className="w-8 h-8 bg-white text-primary rounded-full flex items-center justify-center">
